...
const ProjectCard = ({
   ...
   return (
       <div className={"relative p-4 rounded-2xl bg-zinc-800 hover:bg-zinc-700/50 active:bg-zinc-700/60 ring-1 ring-zinc-50/5 transition-colors flex flex-col h-full " + (classes || "")}>
           ...
           <div className="flex-1 flex flex-col">
               ...
               {/* Date section with sky-400 color */}
               <div className="mb-3">
               ...
               <div className="flex flex-wrap items-center gap-2 mb-4 flex-1">
                   {tags.map((label, key) => (
                       <span
                           key={key}
